...
![Site landing page](assets/readme/main.png)
...
### CI Python Linter
No errors found when running in through the [CI Python Linter](https://pep8ci.herokuapp.com/).
<details>
<summary>run.py</summary>
<img src="assets/readme/run_validation.png" alt="Validation test for run.py"></img>
</details>
<details>
...
### W3C Markup
When I initially tested the deployed page on with the [W3C Markup validator](https://validator.w3.org/), I found an error generated by the way I added the style to the body element. To resolve the issue, I inserted the style within the body instead of including it in a container. 
<details>
<summary>HTML test</summary>
<img src="assets/readme/html_valid.png" alt="Validation test for deployed html"></img>
</details>

### W3C CSS 
No errors found when testing the deployed page with [W3C CSS Validator](https://jigsaw.w3.org/)
<details>
<summary>CSS test</summary>
<img src="assets/readme/jigsaw_valid.png" alt="Validation test for CSS"></img>
</details>

### Lighthouse
The first report generated by lighthouse was not the most satisfactory, reason why I rearranged the code and moved the logo print out from the initializing function to the top of the file. The test after this was as expected. 
<details>
<summary>Lighthouse testing</summary>
<img src="assets/readme/lighthouse1.png" alt="Lighthouse report"></img>
</details>
